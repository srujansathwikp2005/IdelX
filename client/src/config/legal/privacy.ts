...
export const PRIVACY_DOC: LegalDoc = {
  ...
  paragraphs: [
        ...
        "We may also automatically collect technical information such as IP address, browser type, device type, operating system, device identifiers, application version, network information, pages or features accessed, date and time of access, error logs, diagnostic information, and usage information."
      ]
    },
    {
  ...
  paragraphs: [
        ...
        "We may also receive information from other users in connection with a rental, dispute, damage, theft, fraud, complaint, or safety issue."
      ]
    },
    {
  ...
  paragraphs: [
        "You may request deletion or deactivation of your IdelX account by contacting idelxsupport@gmail.com.",
        "IdelX may require reasonable verification of your identity before processing a deletion request.",
        "Deletion of an account does not necessarily mean that all information will immediately be deleted. Information may be retained where necessary for legal compliance, fraud prevention, dispute resolution, transaction records, establishing or defending legal claims, or other legally permitted purposes."
      ]
    },
    {
  ...
  paragraphs: [
        "Name: Pujari Srujan Sathwik Designation: Owner, IdelX Email: idelxsupport@gmail.com Phone: +91 9704426431 Correspondence Address: 10-5-625, Bangle Street, Rayadurgam, Ananthapur, Andhra Pradesh, India. Support Hours: 8 hours per day.",
  ...
  heading: "Contact Us",
  paragraphs: [
        "IdelX Sole Proprietorship Owner: Pujari Srujan Sathwik Email: idelxsupport@gmail.com Phone: +91 9704426431 Business Address: D.No: 17-21-5, Ward No. 3, Near Why Not Shopping Mall, Undarajavaram Road, Tanuku, West Godavari District, Andhra Pradesh, India. Support Hours: 8 hours per day."
      ]
    },
    {
